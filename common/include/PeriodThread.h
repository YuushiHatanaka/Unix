...
// PeriodThread例外クラス
//------------------------------------------------------------------------------
class PeriodThreadException : public Exception
{
public:
    //--------------------------------------------------------------------------
    // コンストラクタ
    //--------------------------------------------------------------------------
    PeriodThreadException(std::string format, ...)
        : Exception()
    {
        // メッセージ生成
        va_list ap;
...
public:
    ...
    // コンストラクタ
    //--------------------------------------------------------------------------
    PeriodThread(std::string name, pthread_attr_t attr) : Thread(name, attr)
    {
        // 初期化
        this->m_periodTimer = 100;
    }
    ...
    // コンストラクタ
    //--------------------------------------------------------------------------
    PeriodThread(std::string name, pthread_attr_t attr, uint64_t timer) : Thread(name, attr)
    {
        // 初期化
        this->m_periodTimer = timer;
    }
